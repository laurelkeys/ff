...
def fly(client: airsim.MultirotorClient, args: argparse.Namespace) -> None:
    ...
    if args.axes:
        client.simPlotTransforms(poses, scale=75.0, thickness=2.5, is_persistent=True)
    else:
    ...
    if args.transformation:
        ...
        if args.axes:
            client.simPlotTransforms(aligned_poses, scale=75.0, thickness=2.5, is_persistent=True)
        else:
            client.simPlotPoints(aligned_positions, args.color, size=10, is_persistent=True)
