...
SCENE_NAME = "angel"
SCENE_FOLDER = os.path.join(FF_PROJECT_ROOT, "scripts", "data", "uavmvs", "angel_v1", "capture-initial_2D")
...
if __name__ == "__main__":
    ...
    precision, recall, fscore, *histogram_data = TanksAndTemplesEvaluator.evaluate_reconstruction(
        ...
        dtau_threshold=dTau,
        # NOTE use the same source point cloud as eval_uavmvs_angel_v1_initial_2D.py
        ...
        source_ply_to_ply_align_txt_path=os.path.join(SCENE_FOLDER, "drone", "data", "align_reconstruction_to_groundtruth.txt"),
